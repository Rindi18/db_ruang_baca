                ...
                <div class="col-sm-10">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="nama_mahasiswa" value="<?= $anggota['nama_mahasiswa'] ?>" placeholder="Nama Mahasiswa">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="angkatan" class="form-control">
                                        <option value="<?= $anggota['id_angkatan'] ?>"><?= $anggota['nama_angkatan'] ?></option>
